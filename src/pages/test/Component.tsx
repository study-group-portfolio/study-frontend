    ...
    <div style={{ marginBottom: "90px" }}>
      <div className={cn(styles.container)}>
        ...
        <div className={cn(styles.textInputSection)}>
          ...
          <div>
            <TextInput value="스터딧" disabled={true} />
          </div>
          <div>
            <TextInput
              value="스터딧"
          ...
          <div>
            <TextInput value="스터딧" textInputState={TextInputState.성공} />
          </div>
        </div>
        ...
        <div className={cn(styles.selectSection)}>
          <Select
            ...
            onChange={(customChangeEvent: CustomChangeEvent) => {
              if (
                ...
                typeof customChangeEvent.value === "string"
              ) {
          ...
          >
            <GroupOptions options={positions} />
          </Select>
          <Select
          ...
          >
            <CheckBoxOptions options={skills} />
          </Select>
        </div>
        <h2>CheckBox</h2>
        <div>
